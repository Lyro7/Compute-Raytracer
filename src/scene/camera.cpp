...
Camera::Camera(const glm::vec3 &lookFrom, const glm::vec3 &lookAt, const glm::vec3 &up, 
...
// Formula for computing the forward vector using yaw and pitch (LearnOpenGL.com)
